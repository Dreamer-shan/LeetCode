...
public class Task3 extends Task<Long> {
    ...
    public Task3(BufferedReader templateReader, BufferedReader configReader, BufferedWriter mergedWriter) {
        super(templateReader, configReader, mergedWriter);
    }
